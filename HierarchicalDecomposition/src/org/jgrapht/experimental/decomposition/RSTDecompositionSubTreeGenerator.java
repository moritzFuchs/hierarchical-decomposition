 ...
 */
public class RSTDecompositionSubTreeGenerator<V extends Comparable<V>,E> extends DecompositionSubTreeGenerator<V,E> implements Observer{

	public RSTDecompositionSubTreeGenerator(DecompositionTree<V> tree, DecompositionTask<V, E> task, ExecutorService exec, Decomposition<V, E> d) {
		super(tree, task, exec, d);
	}
